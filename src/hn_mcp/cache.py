"""
LRU Cache with TTL support for HN-MCP.
...
ESTIMATED_ITEM_SIZE_KB = 50  # Estimated avg item size
...
def cached(cache_type: str = "default") -> Callable[[Callable[P, Awaitable[R]]], Callable[P, Awaitable[R]]]:
    """
